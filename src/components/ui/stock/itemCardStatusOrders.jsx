...
export const ItemCardStatusOrders = ({id, title, description, status, info }) => {
  
  return (
    <Link to={`/ingredient/id/${id}`}>
      <div className="flex justify-between  items-center border-b-1 border-dashed border-gray-200 hover:bg-gray-100 pb-4 ">
